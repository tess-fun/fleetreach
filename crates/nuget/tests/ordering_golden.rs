//! CI-enforced golden regression for the NuGet (NuGetVersion) comparator.
//!
...
//! exercising a documented NuGet quirk, and asserts the comparator reproduces every one — so a
//! regression fails CI without a .NET toolchain present. It also checks antisymmetry.
